...
function ButtonUpdateOrganizaciones(props) {
	...
	const submitOrganizacion = (e) => {
		e.preventDefault();
		fetch("http://localhost/devtic/api/ActualizarOrganizacion.php", {
					...
					<div className="relative w-full max-w-md max-h-full m-auto">
						<div className="relative bg-white rounded-lg shadow dark:bg-gray-700 ">
							...
							<div className="px-6 py-6 lg:px-8">
								...
								<form onSubmit={submitOrganizacion}>
									<div className="relative z-0 w-full mb-6 group">
										<input
											...
											required
											defaultValue={nombreOrganizacion}
										/>
										<label
									...
									<div className="relative z-0 w-full mb-6 group">
										<input
											...
											onChange={handleOnChange}
											required
											defaultValue={direccionOrganizacion}
										/>
										<label
									...
									<div className="relative z-0 w-full mb-6 group">
										<input
											...
											onChange={handleOnChange}
											required
											defaultValue={numeroTelefonoOrganizacion}
										/>
										<label
...
export default ButtonUpdateOrganizaciones;
