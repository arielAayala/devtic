    ...
    case "POST":
        if(isset($_COOKIE["token"])){
            ...
            if ($datos){
                ...
                if($demanda -> actualizarDemanda($_COOKIE["token"], $datos->idDemanda,$datos->idEstado,$datos->idTipo, $datos->idOrganizacion, $datos->tituloDemanda, $datos->motivoDemanda, $datos->almacenDemanda)){
